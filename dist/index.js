"use strict";
class $2627284aee5158d6$var$CandleStick {
    #open;
    #close;
    #high;
    #low;
    ...
    height() {
        return this.isBear() ? this.#open - this.#close : this.#close - this.#open;
    }
    highLowHeight() {
        return this.#high - this.#low;
    }
}
var $2627284aee5158d6$export$2e2bcd8739ae039 = $2627284aee5158d6$var$CandleStick;


"use strict";
class $26adbe0ca0f75320$var$CandleSticksChart extends HTMLElement {
    #data;
    #canvas;
    #context;
    #priceLabelWidth;
    ...
    drawCursor(event) {
        if (event) this.#lastMousePosition = {
    ...
    draw() {
        ...
        this.#data.forEach((json, index)=>{
            const candle = new (0, $2627284aee5158d6$export$2e2bcd8739ae039)(json.open, json.close, json.high, json.low, json.volume);
            ...
            this.#context.fillRect(index * ((0, $2627284aee5158d6$export$2e2bcd8739ae039).width() + 10), candlePosY, (0, $2627284aee5158d6$export$2e2bcd8739ae039).width(), candleHeight);
            ...
            this.#context.fillRect(Math.floor(((0, $2627284aee5158d6$export$2e2bcd8739ae039).width() + 10) * index + (0, $2627284aee5158d6$export$2e2bcd8739ae039).width() / 2), candleHighPosY, candle.highLowWidth(), candleHighHeight);
            this.#context.globalAlpha = .4;
            const volumeHeight = this.#canvas.height / 3 * candle.volume / highestVolume;
            this.#context.fillRect(index * ((0, $2627284aee5158d6$export$2e2bcd8739ae039).width() + 10), this.#canvas.height - volumeHeight, (0, $2627284aee5158d6$export$2e2bcd8739ae039).width(), volumeHeight);
            ...
            if (this.#data.length === index + 1) {
                ...
                this.#context.fillStyle = "#fff";
                this.#context.fillText(parseFloat(candle.close).toFixed(2), this.#canvas.width - 40, posY + 4);
    ...
    updateData(data) {
        ...
        const maxCandles = Math.floor((this.#canvas.width - this.#priceLabelWidth) / ((0, $2627284aee5158d6$export$2e2bcd8739ae039).width() + 10));
        this.#data = data.length > maxCandles ? [
            ...data
        ].slice(-Math.abs(maxCandles)) : data;
        const priceRange = 1;
...
var $26adbe0ca0f75320$export$2e2bcd8739ae039 = $26adbe0ca0f75320$var$CandleSticksChart;


"use strict";
customElements.define("candlestick-chart", (0, $26adbe0ca0f75320$export$2e2bcd8739ae039));
